...
import cucumber.api.testng.AbstractTestNGCucumberTests;
	...
	//@RunWith(Cucumber.class)// need this line for junit
			...
			@CucumberOptions(
			    ...
			    features = {"src/main/resources/Mouse.feature","src/main/resources/Login.feature"},
			    glue = {"com.stepdef"},
			  
			  monochrome=true
			)
			public class Oscommercerunner extends AbstractTestNGCucumberTests {// remove from extends if junit
